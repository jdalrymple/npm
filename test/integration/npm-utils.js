...
// test.serial('Set auth with "NPM_TOKEN"', async () => {
...
// test.serial('Preserve home ".npmrc"', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
//   const env = { NPM_TOKEN: "npm_token" };
...
// test.serial('Preserve home and local ".npmrc"', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
//   const env = { NPM_TOKEN: "npm_token" };
...
// test.serial('Preserve all ".npmrc" if auth is already configured', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
...
// test.serial('Throw error if "NPM_TOKEN" is missing', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
...
// test.serial('Throw error if "NPM_USERNAME" is missing', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
...
// test.serial('Throw error if "NPM_PASSWORD" is missing', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
...
// test.serial('Throw error if "NPM_EMAIL" is missing', async () => {
//   process.env.HOME = tempy.directory();
//   //   process.chdir(cwd);
//   const npmrc = tempy.file({ name: ".npmrc" });
